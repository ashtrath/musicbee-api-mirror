...
Partial Public Class Plugin
    ...
    Public Const MinInterfaceVersion As Short = 43
    Public Const MinApiRevision As Short = 57
    ...
    Public Structure MusicBeeApiInterface
        Public Shared Sub Initialise(ByRef mbApiInterface As MusicBeeApiInterface, apiInterfacePtr As IntPtr)
            ...
            ElseIf mbApiInterface.MusicBeeVersion <= MusicBeeVersion.v3_4 Then
                CopyMemory(mbApiInterface, apiInterfacePtr, 692)
            ElseIf mbApiInterface.MusicBeeVersion = MusicBeeVersion.v3_4_1 Then
                CopyMemory(mbApiInterface, apiInterfacePtr, 696)
            ElseIf mbApiInterface.MusicBeeVersion = MusicBeeVersion.v3_5 Then
                CopyMemory(mbApiInterface, apiInterfacePtr, 700)
            Else
        ...
        Public ReadOnly Property MusicBeeVersion() As MusicBeeVersion
            Get
                ...
                ElseIf ApiRevision <= 53 Then
                    Return MusicBeeVersion.v3_1
                ElseIf ApiRevision < 55 Then
                    Return MusicBeeVersion.v3_4
                ElseIf ApiRevision < 57 Then
                    Return MusicBeeVersion.v3_4_1
                ElseIf ApiRevision < 58 Then
        ...
        ' api version 55
        Public MB_Evaluate As MB_EvaluateDelegate
        ' api version 57
        Public Library_GetNoArtworkUrl As Library_GetNoArtworkDelegate
        ' api version 58
        Public NowPlaying_GetPeak As NowPlaying_GetPeakDelegate
    ...
    Public Delegate Function MB_EvaluateDelegate(expression As String, sourceFileUrl As String) As String
    ...
    Public Delegate Function Library_GetSyncDeltaDelegate(cachedFiles() As String, updatedSince As Date, categories As LibraryCategory, ByRef newFiles() As String, ByRef updatedFiles() As String, ByRef deletedFiles() As String) As Boolean
    Public Delegate Function Library_GetLyricsDelegate(sourceFileUrl As String, type As LyricsType) As String
	Public Delegate Function Library_GetNoArtworkDelegate(pictureType As Integer) As String
    ...
    Public Delegate Sub NowPlaying_GetPeakDelegate(peak() As Single, rms As Boolean)
    ...
    'Public Delegate Function FileList_ClearDelegate(panel As Control) As Boolean
    'Public Delegate Function FileList_AddFilesDelegate(panel As Control, urls() As String) As Boolean
